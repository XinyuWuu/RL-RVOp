        ...
        for Nth in range(Nrobot):
            r[Nth] = r[Nth] + \
                self.target(pos=pos_vel[Nth][0:2],
                            vel=pos_vel[Nth][3:5], target=target[Nth])
            for o in observation[Nth]:
                if o['rvop'].shape[0] == 2:
                    ...
                    r[Nth] = r[Nth] + \
                        self.collision_obs(
                            vel=pos_vel[Nth][2:4], vnear=o['rvop'][6:8])
                    # near
                    r[Nth] = r[Nth] + \
                        self.near_obs(
                            vel=pos_vel[Nth][2:4], vnear=o['rvop'][6:8])
                    ...
                    # other robot
                    # collision
                    r[Nth] = r[Nth] + self.collision_r(pos=pos_vel[Nth][0:2], opos=o['pos']
                                                       [0:2], vel=pos_vel[Nth][3:5], ovel=o['vel'][0:2], vnear=o['rvop'][6:8])
                    # near
                    r[Nth] = r[Nth] + self.near_r(
                        pos=pos_vel[Nth][0:2], opos=o['pos'][0:2], vel=pos_vel[Nth][3:5], ovel=o['vel'][0:2], vnear=o['rvop'][6:8])
                    pass
        return r
...
RW = Reward()
RW.target(array([0, 0]), array([-0.1, 0.1]), array([1, 1]))
