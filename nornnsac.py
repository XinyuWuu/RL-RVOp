...
import nornncore;
importlib.reload(nornncore)


class SAC():
    def __init__(self, obs_dim, act_dim, act_limit, hidden_sizes: list, lr, gamma, polyak, alpha, device) -> None:
        ...
        self.polyak = polyak
        self.lr = lr
        self.Pi = nornncore.Policy(obs_dim, act_dim, act_limit,
                                   hidden_sizes)
        self.Qf1 = nornncore.Qfunc(
            obs_dim, act_dim, hidden_sizes)
        self.Qf2 = nornncore.Qfunc(
            obs_dim, act_dim, hidden_sizes)
